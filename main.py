...
main_application.title('Moin khokhar text Editor')
...
colour_icon =(light_default_icon, light_Plus_icon, dark_icon, red_icon,  
...
#####################Butooon functionality

###bold butoon function
def change_bold():
...
count = 0 
for i in color_dict:
    colour_theme.add_radiobutton(label = i, image=colour_icon[count], variable=theme_choice, compound=tk.LEFT, command=change_theme)
    count += 1 
